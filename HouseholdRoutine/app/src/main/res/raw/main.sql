...
INSERT INTO predefined_checklist VALUES (1, '["Household waste","Paper","Glass","Batteries"]');
INSERT INTO predefined_checklist VALUES (2, '["Kitchen","Living room","Bathroom","Bedroom"]');
INSERT INTO predefined_checklist VALUES (3, '["Window cleaner","Garbage bags","Sponges","Dish soap","Dust bags","Laundry detergent"]');
...
INSERT INTO predefined_reminders VALUES (3, 'Throw away the paper waste', null, 0, 0);
INSERT INTO predefined_reminders VALUES (4, 'Dispose old batteries', 'Remember to dispose them in special containers', 0, 0);
INSERT INTO predefined_reminders VALUES (5, 'Dispose old glass bottles', null, 0, 0);
INSERT INTO predefined_reminders VALUES (6, 'Clean the barthroom', '', 0, 0);
INSERT INTO predefined_reminders VALUES (7, 'Wash the dishes', null, 0, 0);
INSERT INTO predefined_reminders VALUES (8, 'Vacuum the apartment', null, 0, 0);
INSERT INTO predefined_reminders VALUES (9, 'Clean the cat litter box', null, 0, 0);
INSERT INTO predefined_reminders VALUES (10, 'Take medicine', null, 0, 0);
INSERT INTO predefined_reminders VALUES (11, 'Dispose of garbage', null, 1, 1);
...
INSERT INTO predefined_reminders_de VALUES (5, 'Altglas entsorgen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (6, 'Das Badezimmer sauber machen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (7, 'Abwasch machen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (8, 'Die Wohnung saugen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (9, 'Das Katzenklo reinigen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (10, 'Medikamente nehmen', null, 0, 0);
INSERT INTO predefined_reminders_de VALUES (11, 'Müll entsorgen', null, 1, 1);
INSERT INTO predefined_reminders_de VALUES (12, 'Wohnung putzen', null, 2, 1);
INSERT INTO predefined_reminders_de VALUES (13, 'Putzutensilien besorgen', 'Dinge kaufen, um die Wohnung sauber zu halten', 3, 1);

INSERT INTO information_sets VALUES (1, 1, 'https://www.focus.de/finanzen/experten/iwkoeln/abfall-nur-ein-land-in-der-eu-produziert-noch-mehr-muell-als-deutschland_id_6239128.html', 'Focus', 0, 1);
INSERT INTO information_sets VALUES (2, 2, 'https://www.alba.info/unternehmen/service/glossar/abfallhierarchie.html', 'Alba', 0, 1);
INSERT INTO information_sets VALUES (3, 3, 'http://www.latimes.com/world/global-development/la-fg-global-trash-20160422-20160421-snap-htmlstory.html', 'Los Angeles Times', 0, 1);
INSERT INTO information_sets VALUES (4, 4, 'https://www.wissenschaftsjahr.de/2016-17/aktuelles/alle-aktuellen-meldungen/oktober-2017/globale-studie-bestimmt-mengen-an-plastikfracht-in-flusssystemen.html', 'Bundesministerium für Bildung und Forschung', 0, 1);
...
INSERT INTO informations_de VALUES (3, 'Eigene Müllgenerierung', 'Anders als bei Strom und Wasser, bei dem man so viel bezahlt wie man verbraucht, bezahlt man für die Müllabfuhr einen festen Preis. Deswegen bekommen die meisten Menschen gar nicht mit, wie viel Müll sie generieren.');
INSERT INTO informations_de VALUES (4, 'Plastikmüll in den Flüssen', 'Die Zehn größten Flüsse auf der Welt befördern über 90% des Plastikmülls in die Weltmeere. Davon sind acht aus Asien und auf dem ersten Platz liegt der Jangtse.');
...
INSERT INTO informations VALUES (3, 'Own waste generation', 'Unlike water or electricity where we pay for what we use, do we pay a fixed price for the garbage collection. That has the consequence that many people are oblivious to how much waste they actually generate. ');
INSERT INTO informations VALUES (4, 'Plastic waste in rivers', 'The ten largest rivers transport more than 90% of the plasic waste into the oceans. Eight out ten rivers are from Asia and on rank one is the Yangtze.');
